...
텔레그램 버튼으로 예약한 것만 30일 최소 운용기간에 걸었었다. 화면과 대화는
2026-09-05부터 이미 안 걸리게 해 뒀는데, 그래도 텔레그램 버튼을 누른
사람에게는 "직전 변경으로부터 8일이 지났습니다"처럼 막힌 까닭만 가고
바꿀 방법이 없었다. 사람이 눌러서 예약한 것을 사람이 못 되돌리는 값은
의미가 없어서 완전히 없앴다."""
