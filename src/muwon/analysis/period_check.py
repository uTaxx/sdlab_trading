...
3개월이면 거래가 열 건 안팎이다. 그중 크게 오른 한 종목이 숫자의 대부분을
만든다. 그 한 건이 실력인지 운인지 구별할 방법이 없다. 그래서 이 모듈은
**거래 수를 언제나 같이 돌려준다.** 수익률만 보고 판단하면 안 되는 자리다.
...
기간들: tuple[기간정의, ...] = (
    기간정의(
        "3개월", 3, "달",
        "거래가 열 건 안팎이라 운과 실력이 구별되지 않습니다. 방금 바꾼 것이 "
        "돌고는 있는지 보는 용도입니다",
    ),
    기간정의(
        "12개월", 12, "달",
